<?php
define('SCRIPT_ROOT',  WEB_ROOT.'sms/');
...
class Client{
	 ...
	 * 
	 */
	function Client($url='http://hprpt2.eucp.b2m.cn:8080/sdk/SDKService?wsdl',$serialNumber='8SDK-EMY-6699-RKVRR',$password='966806',$sessionKey='414611',$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 2, $response_timeout = 10)
	{
		$this->url = $url;
