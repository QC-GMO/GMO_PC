...
function json_add_cn(obj){  
	...
	var html = "描述：<input name=\"json_title_cn[]\" type=\"text\" size=\"23\" /> &nbsp;&nbsp;&nbsp;"
...
function json_add_en(obj){  
	//var idx  = $('.json_order_id').length; //img_rowindex(src)
	var html = "描述：<input name=\"json_title_en[]\" type=\"text\" size=\"23\" /> &nbsp;&nbsp;&nbsp;"
...
function json_add_jp(obj){  
	//var idx  = $('.json_order_id').length; //img_rowindex(src)
	var html = "描述：<input name=\"json_title_jp[]\" type=\"text\" size=\"23\" /> &nbsp;&nbsp;&nbsp;"
